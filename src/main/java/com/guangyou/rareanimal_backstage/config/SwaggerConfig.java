package com.guangyou.rareanimal_backstage.config;
    ...
    public Docket docket(){
        ...
        ApiInfo apiInfo =
                new ApiInfoBuilder()
                        ...
                        .description("rareanimal后台程序的接口文档")
                        .version("v1.0")
                        .build();
        ...
        docket
                ...
                .apis(RequestHandlerSelectors.basePackage("com.guangyou.rareanimal_backstage.controller"))//设定扫描哪个包（包含子包）
                .build(); //重构docket对象
